...
/**
 * Strings for component 'plugin', language 'id', branch 'MOODLE_39_STABLE'
 *
 * @package   plugin
...
$string['type_auth_plural'] = 'Plugin Otentikasi';
...
$string['type_mod_plural'] = 'Modul-modul aktifitas';
...
$string['type_theme'] = 'Tampilan';
$string['type_theme_plural'] = 'Theme';
