...
/**
 * Strings for component 'rating', language 'id', branch 'MOODLE_39_STABLE'
 *
 * @package   rating
...
*Hitungan penilaian - Jumlah butir yang dinilai menjadi nilai akhir. Perhatikan bahwa jumlah tidak dapat melebihi nilai maksimum untuk aktifitas tersebut
*Penilaian maksimum - Penilaian tertinggi menjadi nilai akhir
*Penilaian Minimum - Penilaian terrendah menjadi nilai akhir
*Jumlah seluruh penilaian - Seluruh penilaian disatukan. Perhatikan bahwa jumlah tidak dapat melebihi nilai maksimum untuk aktifitas tersebut.
Apabila "Tidak ada penilaian" dipilih, maka aktifitas tersebut tidak akan muncul pada buku nilai.';
$string['allowratings'] = 'Izinkan butir untuk dinilai?';
$string['allratingsforitem'] = 'Semua penilaian yang telah diberikan';
$string['capabilitychecknotavailable'] = 'Pemeriksaan kemampuan tidak tersedia hingga aktifitas tersimpan';
$string['couldnotdeleteratings'] = 'Maaf, penghapusan gagal karena rating telah diisi';
$string['grade_rating_name'] = 'Penilaian';
