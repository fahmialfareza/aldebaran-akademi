...
/**
 * Strings for component 'install', language 'id', branch 'MOODLE_39_STABLE'
 *
 * @package   install
...
$string['cliskipdatabase'] = 'Melewati instalasi basis data.';
...
$string['fileuploadshelp'] = '<p> Pengunggahan berkas tampaknya dinonaktifkan di peladen Anda. </p> <p> Moodle masih dapat dipasang, tetapi tanpa kemampuan ini, Anda tidak akan dapat mengunggah berkas pelajaran atau gambar profil pengguna baru. </p> <p> Untuk mengaktifkan pengunggahan berkas. Anda (atau administrator sistem Anda) harus mengedit berkas php.ini utama di sistem Anda dan edit pada baris <b> file_uploads </b> menjadi \'1\'. </p>';
...
$string['sessionautostarthelp'] = '<p> Moodle memerlukan dukungan sesi dan tidak akan berfungsi tanpanya. </p> <p> Sesi dapat diaktifkan di file php.ini ... cari parameter session.auto_start. </p>';
...
$string['upgradingqtypeplugin'] = 'Peningkatan plugin pertanyaan/tipe';
