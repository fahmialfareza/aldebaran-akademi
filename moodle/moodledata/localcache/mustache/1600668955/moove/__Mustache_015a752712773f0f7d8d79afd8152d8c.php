...
class __Mustache_015a752712773f0f7d8d79afd8152d8c extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        if ($parent = $this->mustache->loadPartial('core/popover_region')) {
            $context->pushBlockContext(array(
                ...
                'togglecontent' => array($this, 'block5e78d5b4dcc6e60a7d899b7f0a256ad5'),
                ...
                'headeractions' => array($this, 'block4f8f66449e82255afe4d7090fe4973e1'),
                'content' => array($this, 'block0ea1360a6c5103bf11a91fcb785f81a8'),
            ));
...
';
    ...
    public function block5e78d5b4dcc6e60a7d899b7f0a256ad5($context)
    {
        $indent = $buffer = '';
...
';
    ...
    public function block5f4f8bedf604b2dbe121c8f2d820ec78($context)
    {
        $indent = $buffer = '';
...
';
    ...
    public function blockC16db3e43d761ea351afb3f61fcbec23($context)
    {
        $indent = $buffer = '';
        $buffer .= '                <a href="';
...
';
    ...
    public function block4f8f66449e82255afe4d7090fe4973e1($context)
    {
        $indent = $buffer = '';
        $buffer .= '        ';
        if ($parent = $this->mustache->loadPartial('core/hover_tooltip')) {
            $context->pushBlockContext(array(
                'anchor' => array($this, 'block5f4f8bedf604b2dbe121c8f2d820ec78'),
        ...
        if ($parent = $this->mustache->loadPartial('core/hover_tooltip')) {
            $context->pushBlockContext(array(
                'anchor' => array($this, 'blockC16db3e43d761ea351afb3f61fcbec23'),
    ...
    public function block0ea1360a6c5103bf11a91fcb785f81a8($context)
    {
        $indent = $buffer = '';
