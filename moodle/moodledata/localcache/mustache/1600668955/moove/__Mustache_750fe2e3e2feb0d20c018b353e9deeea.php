...
class __Mustache_750fe2e3e2feb0d20c018b353e9deeea extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->section00548a6ca3b02f27f7b3ff201c2fedc6($context, $indent, $value);
        $buffer .= $indent . '
';
...
';
        // 'output.get_logo' section
        $value = $context->findDot('output.get_logo');
        $buffer .= $this->sectionFa2bbb203b1071b7cbe0340e96bf5e1d($context, $indent, $value);
        // 'output.get_logo' inverted section
        $value = $context->findDot('output.get_logo');
        if (empty($value)) {
...
';
    ...
    private function section00548a6ca3b02f27f7b3ff201c2fedc6(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
    ...
    private function sectionFa2bbb203b1071b7cbe0340e96bf5e1d(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
