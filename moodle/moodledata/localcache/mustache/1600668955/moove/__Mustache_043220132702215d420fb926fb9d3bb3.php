...
class __Mustache_043220132702215d420fb926fb9d3bb3 extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->section2624d387ac5e7cb16fcbf6148d2f323e($context, $indent, $value);
        $buffer .= $indent . '</ul>';

        return $buffer;
    }

    private function section49aa346a04784fa3cee6e8e46dea55da(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
    ...
    private function section0bb6da88c269243219b8634f6526036e(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
    ...
    private function section7c9d2eef541e49684ad5c3479b6802ef(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
    ...
    private function section11f36da0a61f17734a53be2213050776(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
    ...
    private function section2624d387ac5e7cb16fcbf6148d2f323e(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
            ...
            foreach ($values as $value) {
                ...
                $buffer .= $this->section49aa346a04784fa3cee6e8e46dea55da($context, $indent, $value);
                // 'action' section
                $value = $context->find('action');
                $buffer .= $this->section0bb6da88c269243219b8634f6526036e($context, $indent, $value);
...
';
                    // 'is_section' section
                    $value = $context->find('is_section');
                    $buffer .= $this->section7c9d2eef541e49684ad5c3479b6802ef($context, $indent, $value);
                    $buffer .= $indent . '                    <span class="text">';
                    $value = $this->resolveValue($context->find('text'), $context);
                    $buffer .= $value;
                    $buffer .= '</span>
...
';
                    ...
                    $buffer .= $this->section11f36da0a61f17734a53be2213050776($context, $indent, $value);
                    $buffer .= $indent . '                </ul>
';
                    $buffer .= $indent . '            </li>
';
