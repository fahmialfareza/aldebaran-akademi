...
class __Mustache_8a060af2a556cd56ce81352f6e028171 extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->section5df9fb6216a40faa6312205c8ebc59f9($context, $indent, $value);
        $buffer .= $indent . '            <li>
';
        $buffer .= $indent . '                <a class="dropdown-item ';
        // 'lastaccessed' section
...
';
    ...
    private function section5df9fb6216a40faa6312205c8ebc59f9(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
                ...
                $value = $context->find('shortname');
                $buffer .= $this->section5749c750acb0d7477dd5257d00cc6d53($context, $indent, $value);
                $buffer .= '" href="#" data-filter="sort" data-pref="shortname" data-value="shortname" aria-label="';
                // 'str' section
                $value = $context->find('str');
